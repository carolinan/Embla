...
function embla_customize_register_icon( $wp_customize ) {
		...
		public function render_content() {
			...
			<div class="embla-radio-buttons">
				<fieldset>
					...
					?>
						<label>
						<?php echo '<span class="screen-reader-text">' . esc_html( 'Icon name: ', 'embla' ) . $value . '</span>'; ?>
	...
	$wp_customize->add_setting( 'embla_show_header_icon', array(
		'sanitize_callback' => 'embla_sanitize_checkbox',
		'default' => true,
	) );

	$wp_customize->add_control( 'embla_show_header_icon', array(
		'type' => 'checkbox',
		'label' => __( 'Show the icon and the header.', 'embla' ),
		'section' => 'embla_options',
		'priority' => 110,
	) );
	...
	$wp_customize->add_control( 'embla_show_footer_icon', array(
		'type' => 'checkbox',
		'label' => __( 'Show the icon and the footer.', 'embla' ),
		'section' => 'embla_options',
		'priority' => 110,
	) );
